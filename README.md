...
LM Music 是一个面向浏览器和移动端安装场景的 PWA 音乐播放器，支持连接个人音乐服务，也支持浏览公开音乐目录。
...
> 注意：Audius 是公开流媒体目录，不提供离线下载。Jellyfin / Navidrome 是否能正常播放，还取决于服务器跨域、音频格式和浏览器解码能力。
