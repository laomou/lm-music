...
<template>
  <aside v-if="player.currentTrack" class="mini-player">
    <button class="mini-player-open" @click="router.push('/now-playing')">
    ...
    <button class="mini-toggle-wrap" :aria-label="player.isPlaying ? t('player.pause') : t('player.play')" @click="player.togglePlayback()">
